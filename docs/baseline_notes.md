...
Server templates for later baseline execution live under `scripts/server/`. They must be manually edited on the remote server with real dataset, feature, checkpoint, result, and log roots before use.
